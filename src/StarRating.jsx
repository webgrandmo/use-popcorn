			...
			<div style={starContainerStyle}>
				{Array.from({ length: maxRating }, (_, i) => (
					<Star
						...
						onEnter={() => handleMouseEnter(i + 1)}
						onLeave={() => handleMouseLeave(0)}
...
function Star({ onClick, onEnter, onLeave, isFull, color, size }) {
	const starStyle = {
		width: `${size}px`,
		height: `${size}px`,
		display: 'block',
	...
	return (
		<span role='button' style={starStyle} onClick={onClick} onMouseEnter={onEnter} onMouseLeave={onLeave}>
			{isFull ? (
